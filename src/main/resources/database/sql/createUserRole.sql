...
ALTER TABLE rh.userrole
  ADD CONSTRAINT user_id_const FOREIGN KEY (user_id) REFERENCES rh."user" (id) MATCH FULL;
ALTER TABLE rh.userrole
  ADD CONSTRAINT role_id_const FOREIGN KEY (role_id) REFERENCES rh."role" (id) MATCH FULL;